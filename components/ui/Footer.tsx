...
export default function Footer() {
  return (
    <footer className="w-full bg-red-950 text-cream px-8 md:px-16 pb-6 pt-6 md:pt-10">
      <div className="flex flex-col gap-10 md:flex-row md:justify-between">
        {/* left side with contact info */}
        <div className="max-w-3xl space-y-5">
          <p className="font-serif font-bold text-md md:text-xl text-cream/90">
          ...
          <a
            ...
            className="flex items-center gap-3 text-cream text-serif text-medium text-xl hover:opacity-70 transition-opacity"
          >
            <InstagramIcon />
          ...
          <p className="font-ephesis text-4xl text-cream">
            Love Kait &amp; Cal
          </p>
      ...
      <div className="w-full flex flex-col md:flex-row md:justify-between md:items-center gap-2 mx-auto mt-12 pt-6 border-t border-white/10">
        <p className="text-xs text-cream/40 tracking-widest">
